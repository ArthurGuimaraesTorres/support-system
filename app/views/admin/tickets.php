...
<div class="container mt-4">
    <h1 class="h3 mb-4">Monitoramento de Chamados</h1>
    ...
    <form method="GET" action="index.php" class="row g-3 mb-4">
        ...
        <div class="col-12 d-flex gap-2">
            ...
            <a href="?page=admin_tickets" class="btn btn-secondary"><i class="bi bi-eraser-fill me-2"></i>
                Limpar
            </a>
        </div>
    </form>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        <a class="btn btn-sm btn-outline-secondary"
                            href="?page=admin_ticket_show&ticket_id=<?= (int) $ticket['id'] ?>">
                            Visualizar
                        </a>
                    </td>
                </tr>
