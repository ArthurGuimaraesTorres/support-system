...
<div class="container mt-5">
    ...
    <form action="index.php" method="GET">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="ticket_id" name="ticket_id" min="1"
        ...
        <a href="?page=track_tickets" class="btn btn-secondary"><i class="bi bi-eraser-fill me-2"></i>Limpar
            Pesquisa</a>
    </form>
    ...
    <div class="card mt-4">
        <div class="card-header">
            Chamado #<?= htmlspecialchars($ticket['id'], ENT_QUOTES, 'UTF-8'); ?> -
